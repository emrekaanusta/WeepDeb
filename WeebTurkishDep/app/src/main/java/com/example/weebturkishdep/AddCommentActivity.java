...
public class AddCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.back_button_addComment).setOnClickListener(v -> {
            ...
            // Return to CommentsActivity
            Intent commentsIntent = new Intent(AddCommentActivity.this, CommentsActivity.class);
            commentsIntent.putExtra("THREAD_ID", threadId);
            commentsIntent.putExtra("USERNAME", username);
            commentsIntent.putExtra("COMMENT_CONTENT", commentText);
